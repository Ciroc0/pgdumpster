...
- latest local validation: **117 test files / 752 tests, PASS**;
- current global coverage is **94.50% statements / 90.02% branches / 92.65% functions / 95.45% lines**, with all independent 90% thresholds passing;
