...
- Edge Function deployed-representation capture and secret inventory; automatic function restore remains blocked because the captured body is not a deployable source tree;
