...
| A.3–A.4                  | implemented + evidenced          | Preceding candidate SHA `0197c4f65f4f020adf3c814d6251fdf494514ee2` passed CI run `31976965121`, including Node 22/24 on Ubuntu, macOS and Windows. The final `0.1.1` candidate must repeat this evidence.                                                                                                                                                                                                                              |
...
| P.185                    | implemented + evidenced          | CodeQL run `31976965125` completed successfully for preceding candidate SHA `0197c4f65f4f020adf3c814d6251fdf494514ee2`; the final `0.1.1` candidate must repeat the workflow.                                                                                                                                                                                                                                                          |
...
| Q.201–Q.203              | implemented but evidence missing | Preceding candidate `0197c4f65f4f020adf3c814d6251fdf494514ee2` passed protected Live E2E run `31976974455` with terminal 55-component coverage, 20 verified planned restore actions, matching database/direct Storage/Auth smokes and restored Edge Function invocation. The final `0.1.1` candidate must repeat it; Vault ciphertext, Edge secret plaintext and private Auth signing material remain explicit manual/platform limits. |
